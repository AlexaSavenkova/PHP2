...
abstract class Repository
{
    ...
    public function getOneWhere($name, $value)
    {
        ...
        return Db::getInstance()->queryOneObject($sql, ['value' => $value], $this->getEntityClass()); // возвращает объект
    }
    ...
    public function getOneWhereAnd(array $params)
    {
       ...
       return Db::getInstance()->queryOneObject($sql, $params, $this->getEntityClass()); // возвращает объект
    }
    ...
    public function getOne($id)
    {
        ...
        return Db::getInstance()->queryOneObject($sql, ['id' => $id], $this->getEntityClass()); // возвращает объект
    }
